...
_LOCATION_KIND_TO_SCENE_TYPE: dict[LocationKind, SceneType] = {
    ...
    LocationKind.TEAM_HQ:        SceneType.LOCKER_ROOM,
    LocationKind.TRAINING_GROUND: SceneType.TRAINING_GROUND,
    LocationKind.NEIGHBORHOOD:   SceneType.PARK,
    LocationKind.CAFE:           SceneType.CAFE,
    LocationKind.BAR:            SceneType.BAR,
    LocationKind.MEDIA:          SceneType.PRESS_ROOM,
    LocationKind.TRANSIT:        SceneType.BUS,
...
_SCENE_TYPE_TO_LOCATION_KIND: dict[SceneType, LocationKind] = {
    ...
    SceneType.PRESS_ROOM:      LocationKind.MEDIA,
    SceneType.STUDIO:          LocationKind.MEDIA,
    SceneType.PHOTO_SHOOT:     LocationKind.MEDIA,
    # Transit — one shared visual kind (team bus / car / plane interior).
    SceneType.BUS:             LocationKind.TRANSIT,
    SceneType.CAR:             LocationKind.TRANSIT,
    SceneType.PLANE:           LocationKind.TRANSIT,
}
